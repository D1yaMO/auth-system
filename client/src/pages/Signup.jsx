  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{
        ...
        <h2 style={{ marginBottom: '0.25rem', fontSize: '1.8rem', color: '#1e1b4b' }}>Create account</h2>
        <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>Join us today, it's free</p>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '1rem' }}>
            <label style={{ display: 'block', marginBottom: '0.4rem', color: '#374151', fontWeight: 500 }}>Username</label>
            <input
              type="text"
